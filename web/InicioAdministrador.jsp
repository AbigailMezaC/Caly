<%-- 
    ...
    Created on : 25/05/2022, 03:28:47 PM
    Author     : anaca
--%>
    ...
    <body>
        <div class="banner">
            ...
            <div class="content">
                ...
                <div>
                    <button type="button" onclick="location.href = 'ConsultarDatos.jsp'"><span></span>Consultar Cuentas</button>
                    <button type="button" onclick="location.href = 'ConsultarReporte.jsp'"><span></span>Consultar Reportes</button>
                    <button type="button" onclick="location.href = 'RegistrarPersonal.jsp'"><span></span>Agregar Tecnico</button>
                    <button type="button" onclick="location.href = 'ConsultarPersonal.jsp'"><span></span>Consultar Tecnicos</button>
                </div>
            </div>
