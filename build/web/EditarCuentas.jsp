...
<html>
    ...
    <body onpaste="return false" oncopy="return false">
        ...
        <div class="Chocolate">
            ...
            <br>
            <form action="actualizarCuenta" method="post" name="edita_usuario" id="edita _usuario">
                <%
                ...
                <button type="button" onclick="location.href = 'ConsultarDatos.jsp'"><span></span>Regresar</button>
            </form>
        </div>
    </body>
</html>
