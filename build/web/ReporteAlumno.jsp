...
<html>
    ...
    <body>
        ...
        <div class="Chocolate2">
            <h1>Reporte</h1>
            <br>
            <form method="post" action="reporteAlumno" name="reporteAlumno" id="reporteAlumno">
                <label>Identificador:</label>
                <input type="text" maxlength="10" name="usu" id="usu" placeholder="Ingresa tu Identificador" onkeypress="return(event.charCode >= 48 && event.charCode <= 57)">
                <br>
                <br>
                ...
                <br>
                <label>Fecha:</label>
                <input type="date" maxlength="15" name="fecha_reporte" required="true" id="fecha_report" onkeypress="return(event.charCode >= 48 && event.charCode <= 57)">
                <br>
                <br>
