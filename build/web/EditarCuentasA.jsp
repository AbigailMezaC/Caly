<%-- 
    Document   : EditarCuentas
    Created on : 16/06/2022, 12:51:10 PM
    Author     : ommyr
--%>
...
<html>
    ...
    <body onpaste="return false" oncopy="return false">
        ...
        <div class="Chocolate">
            ...
            <br>
            <form action="actualizarCuentaA" method="post" name="edita_usuario" id="edita _usuario">
                <%
                ...
                <input type="text" readonly="readonly" maxlength="10" name="identificador" value="<%=e.getId_usuario()%>" required="true" id="id_usu"
                ...
                <button type="button" onclick="location.href = 'ConsultarAlumnos.jsp'"><span></span>Regresar</button>
            </form>
        </div>
    </body>
</html>
